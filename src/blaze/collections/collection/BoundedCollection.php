...
/**
 * A collection decorator which specifies bounds for a collection
 *
...
final class BoundedCollection extends AbstractCollectionDecorator implements \blaze\collections\Bounded {
    ...
    /**
     * Creates a new decorator for a collection which is bounded.
     *
    ...
    /**
     * {@inheritDoc}
     * When the collection has not enough space for all object nothing is added and false is returned.
     */
