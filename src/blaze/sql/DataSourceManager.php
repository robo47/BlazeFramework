...
final class DataSourceManager extends Object implements Singleton {
    ...
    /**
     *
     * @var blaze\sql\DataSourceManager
     */
     ...
     *
     * @return 	blaze\sql\DataSourceManager A Singleton instance
     * @see 	blaze\sql\DataSource
     */
     ...
     * @return blaze\sql\DataSource A Datasource to the given dsn.
     * @throws blaze\sql\SQLException Is thrown if a database error occurs.
     */
    public function getDataSource($dsn, $uid = null, $pwd = null, $options = null) {
        ...
        $className = '\\blaze\\sql\\driver\\'.$driver.'\\DataSourceImpl';
