...
//
// So called private static inner classes
//

class ImmutableList implements ListI, Immutable{
    private $obj;

    public function __construct(ListI $obj){
        $this->obj = $obj;
    }
}
class ImmutableCollection implements Collection, Immutable{
    private $obj;
...
class ImmutableMap implements Map, Immutable{
    private $obj;

    public function __construct(Map $obj){
        $this->obj = $obj;
    }
}
class ImmutableSet implements Set, Immutable{
    private $obj;
...
class ImmutableSortedMap implements SortedMap, Immutable{
    private $obj;

    public function __construct(SortedMap $obj){
        $this->obj = $obj;
    }
}
class ImmutableSortedSet implements SortedSet, Immutable{
    private $obj;

    public function __construct(SortedSet $obj){
        $this->obj = $obj;
    }
}
